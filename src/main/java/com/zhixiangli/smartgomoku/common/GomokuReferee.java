...
public class GomokuReferee {
    ...
    public static boolean isWin(Chessboard chessboard, Point point) {
        return Arrays
            .stream(GomokuConstant.DIRECTIONS)
            .anyMatch(
                direction -> getContinuousCount(chessboard, point, direction).getFirst() >= GomokuConstant.CONTINUOUS_NUMBER);
    }
     ...
     */
    public static Pair<Integer, Integer> getContinuousCount(Chessboard chessboard, Point point,
        Point delta) {
