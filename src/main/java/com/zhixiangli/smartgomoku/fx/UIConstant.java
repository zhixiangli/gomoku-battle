...
public class UIConstant {
     ...
     * copyright.
     */
    public static final String COPYRIGHT = String.format("©%d ZhixiangLi", Calendar.getInstance()
        .get(Calendar.YEAR));
     ...
     * build choice box.
     */
    public static final ObservableList<String> CHOICE_BOX_CHOICES = FXCollections
        .observableArrayList();
    static {
